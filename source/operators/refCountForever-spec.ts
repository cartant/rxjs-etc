...
describe("refCountForever", () => {
    ...
    it("should subscribe to the source once", marbles(m => {
    ...
    it("should not unsubscribe on a ref count of zero", marbles(m => {
    ...
    it("should unsubscribe on completion", marbles(m => {
    ...
    it("should unsubscribe on error", marbles(m => {
