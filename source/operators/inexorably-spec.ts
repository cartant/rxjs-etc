...
describe("inexorably", () => {
    ...
    it("should handle empty", marbles(m => {

        let executed = false;
        let s = m.hot("|");
        let result = s.pipe(inexorably((notification: Notification<number> | undefined) => {
            expect(notification).to.not.be.undefined;
            expect(notification).to.have.property("kind", "C");
            executed = true;
        }));
    ...
    it("should handle never", marbles(m => {
    ...
    it("should handle throw", marbles(m => {
    ...
    it("should handle basic hot observable", marbles(m => {
    ...
    it("should handle basic cold observable", marbles(m => {
    ...
    it("should handle basic error", marbles(m => {
    ...
    it("should handle unsubscription", marbles(m => {
